...
myreider={
    ...
    'train_data': 'E:/reid/pyppbox/pyppbox/data/datasets/GTA_V_DATASET/body_128x256', 
...
trainReIDClassifier(
    ...
    classifier_pkl="E:/reid/pyppbox/pyppbox/data/modules/torchreid/models/torchreid/new_osnet_ain_ms_d_c.pth.tar" # Set classifier_pkl="" to use the default in line 14
)
